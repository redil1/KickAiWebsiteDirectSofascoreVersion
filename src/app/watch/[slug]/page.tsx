...
export default async function MatchPage({ params }: PageProps) {
  ...
  // Fetch Advanced Real Data from Sofascore
  // Note: We need a valid Event ID. Since we don't store it reliably yet, we'll try to search.
  ...
  const eventId = match.eventId ? String(match.eventId) : null
      ...
      <div className="mx-auto max-w-7xl px-4 pb-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* NEW: ADVANCED REAL DATA SECTION */}
